...
/**
* get_val - fetches the value of a card from its string representation
...
/**
* swap_node - exchanges a node with another
...
/**
* sort_deck - organizes a linked list of cards in ascending order
