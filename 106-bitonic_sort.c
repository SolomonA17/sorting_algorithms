#include "sort.h"
/**
* bitonic_compare - performs sorting using the bitonic algorithm
...
/**
* bitonic_merge - recursively merges sub-arrays
* @up: sorting direction
* @array: sub-array to be sorted
* @size: size of the sub-array
*
...
/**
* bit_sort - recursive bitonic sorting algorithm
* @up: sorting direction
* @array: sub-array to be sorted
* @size: size of the sub-array
...
/**
* bitonic_sort - sorts an array in ascending order using the bitonic sort algorithm
