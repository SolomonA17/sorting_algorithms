...
/**
* sift_down - repair a heap structure
...
/**
* make_heap - convert an unsorted array into a heap
...
/**
* heap_sort - arrange an array of integers in ascending order using the Heap sort algorithm
